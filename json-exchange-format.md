...
```javascript
{
    "eexcess-user-profile": {
        ...
        /* Should we have user credentials?, e.g. 
        “userCredentials”: {
            “Mendeley”: {
        ...
        */
        /* Please add a compentence level (or similar) to the interest, e.g. expert on recommender systems, but novice to search algorithms.*/
        "interests": [{   // concepts
            ...
            },
            {
                ...
                "weight": "1.0",
/* defines the source of the context information, either manually
   input by the user or automatically inferred from interactions
  For automatic inference we also have a confidence score 
  ranging fromo 0 to 1. */
“source”: “automatic”,
“confidence:” 0.7,
...
“source”: “manual”,
                "weight": "1.0"
                /* uri may not necessarily be present */
            }],
        "context-list": {
            “locations”: [{
                “text”:”Vienna”,
